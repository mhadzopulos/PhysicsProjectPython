...
def change():
    ...
    pointer1 = arrow(pos=(7,1.25,1), axis=(2,-25,0), shaftwidth=.1,length=2,color=color.red)
    pointer2 = arrow(pos=(2,1.25,1), axis=(2,-25,0), shaftwidth=.1,length=2,color=color.red)
    pointer3 = arrow(pos=(5,1.25,1), axis=(2,-25,0), shaftwidth=.1,length=2,color=color.red)
    ...
    acceleration = (charge * Efield)/mass
    deltat = .00000000005
    time = 0
    Vi = 20000000
    Vy = 0
